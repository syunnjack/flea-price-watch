...
const saveKey = 'flea-price-watch.saved'
const postKey = 'flea-price-watch.posts'
const alerts = [
  {
    "id": "flea-price-watch-1",
    "title": "相場 alert seed 1",
    "area": "名古屋",
    "category": "相場",
    "score": 95,
    "summary": "フリマ相場、値下げ、新着、売れ筋を通知し、有料ウォッチ、分析ツール、アフィリエイトへつなげる。 相場の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "flea-price-watch-2",
    "title": "値下げ alert seed 2",
    "area": "東京",
    "category": "値下げ",
    "score": 92,
    "summary": "フリマ相場、値下げ、新着、売れ筋を通知し、有料ウォッチ、分析ツール、アフィリエイトへつなげる。 値下げの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "flea-price-watch-3",
    "title": "新着 alert seed 3",
    "area": "大阪",
    "category": "新着",
    "score": 89,
    "summary": "フリマ相場、値下げ、新着、売れ筋を通知し、有料ウォッチ、分析ツール、アフィリエイトへつなげる。 新着の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "flea-price-watch-4",
    "title": "売れ筋 alert seed 4",
    "area": "静岡",
    "category": "売れ筋",
    "score": 86,
    "summary": "フリマ相場、値下げ、新着、売れ筋を通知し、有料ウォッチ、分析ツール、アフィリエイトへつなげる。 売れ筋の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">フリマ相場・値下げ通知</p>
          <h1>Flea Price Watch</h1>
          <p className="lead">フリマ相場、値下げ、新着、売れ筋を通知し、有料ウォッチ、分析ツール、アフィリエイトへつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>fleaprice.jp / flea-price-watch</span>
